"""EN MOSTAFA AI AGENT REST bridge and live dashboard.

Security note: the public release binds to loopback and starts in read-only
mode by default. Power tools must be enabled explicitly by the operator.
"""
